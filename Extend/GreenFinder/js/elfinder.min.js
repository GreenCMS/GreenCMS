...
(function (a) {
    window.elFinder = function (b, c) {
        ...
        this.api = null, this.newAPI = !1, this.oldAPI = !1, this.OS = navigator.userAgent.indexOf("Mac") !== -1 ? "mac" : navigator.userAgent.indexOf("Win") !== -1 ? "win" : "other", this.options = a.extend(!0, {}, this._options, c || {}), c.ui && (this.options.ui = c.ui), c.commands && (this.options.commands = c.commands), c.uiOptions && c.uiOptions.toolbar && (this.options.uiOptions.toolbar = c.uiOptions.toolbar), a.extend(this.options.contextmenu, c.contextmenu), this.requestType = /^(get|post)$/i.test(this.options.requestType) ? this.options.requestType.toLowerCase() : "get", this.customData = a.isPlainObject(this.options.customData) ? this.options.customData : {}, this.id = g, this.uploadURL = c.urlUpload || c.url, this.namespace = h, this.lang = this.i18[this.options.lang] && this.i18[this.options.lang].messages ? this.options.lang : "en", I = this.lang == "en" ? this.i18.en : a.extend(!0, {}, this.i18.en, this.i18[this.lang]), this.direction = I.direction, this.messages = I.messages, this.dateFormat = this.options.dateFormat || I.dateFormat, this.fancyFormat = this.options.fancyDateFormat || I.fancyDateFormat, this.today = (new Date(G.getFullYear(), G.getMonth(), G.getDate())).getTime() / 1e3, this.yesterday = this.today - 86400, H = this.options.UTCDate ? "UTC" : "", this.getHours = "get" + H + "Hours", this.getMinutes = "get" + H + "Minutes", this.getSeconds = "get" + H + "Seconds", this.getDate = "get" + H + "Date", this.getDay = "get" + H + "Day", this.getMonth = "get" + H + "Month", this.getFullYear = "get" + H + "FullYear", this.cssClass = "ui-helper-reset ui-helper-clearfix ui-widget ui-widget-content ui-corner-all GreenFinder GreenFinder-" + (this.direction == "rtl" ? "rtl" : "ltr") + " " + this.options.cssClass, this.storage = function () {
            ...
            b.helper.toggleClass("GreenFinder-drag-helper-plus", a.shiftKey || a.ctrlKey || a.metaKey)
        }, stop: function () {
            d.trigger("focus").trigger("dragstop")
        }, helper: function (b, c) {
            var e = this.id ? a(this) : a(this).parents("[id]:first"), f = a('<div class="GreenFinder-drag-helper"><span class="GreenFinder-drag-helper-icon-plus"/></div>'), g = function (a) {
                return'<div class="GreenFinder-cwd-icon ' + d.mime2class(a) + ' ui-corner-all"/>'
            }, h, i;
            return d.trigger("dragstart", {target: e[0], originalEvent: b}), h = e.is("." + d.res("class", "cwdfile")) ? d.selected() : [d.navId2Hash(e.attr("id"))], f.append(g(r[h[0]].mime)).data("files", h), (i = h.length) > 1 && f.append(g(r[h[i - 1]].mime) + '<span class="GreenFinder-drag-num">' + i + "</span>"), f
        }}, this.droppable = {tolerance: "pointer", accept: ".GreenFinder-cwd-file-wrapper,.GreenFinder-navbar-dir,.GreenFinder-cwd-file", hoverClass: this.res("class", "adroppable"), drop: function (b, c) {
        ...
        a.extend(a.ui.keyCode, {F1: 112, F2: 113, F3: 114, F4: 115, F5: 116, F6: 117, F7: 118, F8: 119, F9: 120}), this.dragUpload = !1, this.xhrUpload = typeof XMLHttpRequestUpload != "undefined" && typeof File != "undefined" && typeof FormData != "undefined", this.transport = {}, typeof this.options.transport == "object" && (this.transport = this.options.transport, typeof this.transport.init == "function" && this.transport.init(this)), typeof this.transport.send != "function" && (this.transport.send = function (b) {
            ...
            !l && d.visible() && d.ui.overlay.is(":hidden") && (l = !0, a("texarea:focus,input:focus,button").blur(), b.removeClass("GreenFinder-disabled"))
        }).disable(function () {
            m = l, l = !1, b.addClass("GreenFinder-disabled")
        }).open(function () {
            s = []
        }).select(function (b) {
            ...
            var c = {cssClass: "GreenFinder-dialog-error", title: d.i18n(d.i18n("error")), resizable: !1, destroyOnClose: !0, buttons: {}};
            c.buttons[d.i18n(d.i18n("btnClose"))] = function () {
                a(this).elfinderdialog("close")
            }, d.dialog('<span class="GreenFinder-dialog-icon GreenFinder-dialog-icon-error"/>' + d.i18n(b.data.error), c)
            ...
            m && d.enable()
        }}), cwd: a("<div/>").appendTo(b).elfindercwd(this), notify: this.dialog("", {cssClass: "GreenFinder-dialog-notify", position: {top: "12px", right: "12px"}, resizable: !1, autoOpen: !1, title: "&nbsp;", width: 280}), statusbar: a('<div class="ui-widget-header ui-helper-clearfix ui-corner-bottom GreenFinder-statusbar"/>').hide().appendTo(b)}, a.each(this.options.ui ||
            [], function (c, e) {
            var f = "GreenFinder" + e, g = d.options.uiOptions[e] || {};
        ...
        return a = "GreenFinder-" + a + this.id, b !== void 0 && c.setItem(a, b), c.getItem(a) || ""
    }, cookie: function (b, c) {
        var d, e, f, g;
        b = "GreenFinder-" + b + this.id;
        if (c === void 0) {
        ...
        var c = !1, d = {cssClass: "GreenFinder-dialog-confirm", modal: !0, resizable: !1, title: this.i18n(b.title || "confirmReq"), buttons: {}, close: function () {
        ...
        return b.reject && (d.buttons[this.i18n(b.reject.label)] = function () {
            ...
            c > parseInt(b.width()) && a(this).closest(".GreenFinder-dialog").width(c + 30)
        }), this.dialog('<span class="GreenFinder-dialog-icon GreenFinder-dialog-icon-confirm"/>' + this.i18n(b.text), d)
        ...
        var b = "";
        return!a.read && !a.write ? b = "GreenFinder-na" : a.read ? a.write || (b = "GreenFinder-ro") : b = "GreenFinder-wo", b
        ...
        return(d == "all" || d === !0 || a.isArray(d) && a.inArray(b, d) != -1) && window.console && window.console.log && window.console.log("GreenFinder debug: [" + b + "] [" + this.id + "]", c), this
    }, time: function (a) {
        ...
        return this.disabled() || !j.length ? e.reject() : (b.disable(), j.find(".GreenFinder-cwd-filename").empty("").append(k.val(i.name)), k.select().focus(), e)
    }}}, a.fn.dialogelfinder = function (b) {
        var c = "elfinderPosition", d = "elfinderDestroyOnClose";
        this.not(".GreenFinder").each(function () {
            ...
            h.width(parseInt(h.width()) || 840).data(d, !!b.destroyOnClose).find(".GreenFinder-toolbar").removeClass("ui-corner-top"), b.position && h.data(c, b.position), b.autoOpen !== !1 && a(this).dialogelfinder("open")
        });
        if (b == "open") {
        ...
        function (b) {
            return this.each(function () {
                var c = "class", d = b.fm, e = d.res(c, "disabled"), f = d.res(c, "active"), g = d.res(c, "hover"), h = "GreenFinder-button-menu-item", i = "GreenFinder-button-menu-item-selected", j, k = a(this).addClass("ui-state-default GreenFinder-button").attr("title", b.title).append('<span class="GreenFinder-button-icon GreenFinder-button-icon-' + b.name + '"/>').hover(function (a) {
                ...
                a.isArray(b.variants) && (k.addClass("GreenFinder-menubutton"), j = a('<div class="ui-widget ui-widget-content GreenFinder-button-menu ui-corner-all"/>').hide().appendTo(k).zIndex(10 + k.zIndex()).delegate("." + h, "hover",function () {
        ...
        return this.each(function () {
            var c = a(this).addClass("ui-helper-reset ui-widget ui-state-default ui-corner-all GreenFinder-contextmenu GreenFinder-contextmenu-" + b.direction).hide().appendTo("body").delegate(".GreenFinder-contextmenu-item", "hover", function () {
                a(this).toggleClass("ui-state-hover")
            }), d = b.direction == "ltr" ? "left" : "right", e = a.extend({}, b.options.contextmenu), f = '<div class="GreenFinder-contextmenu-item"><span class="GreenFinder-button-icon {icon} GreenFinder-contextmenu-icon"/><span>{label}</span></div>', g = function (b, c, d) {
                return a(f.replace("{icon}", c ? "GreenFinder-button-icon-" + c : "").replace("{label}", b)).click(function (a) {
                ...
                c.css(n).show(), n = {"z-index": n["z-index"] + 10}, n[d] = parseInt(c.width()), c.find(".GreenFinder-contextmenu-sub").css(n)
            }, i = function () {
                c.hide().empty()
            }, j = function (d, f) {
                var h = !1;
                a.each(e[d] || [], function (d, e) {
                    var j, k, l;
                    if (e == "|" && h) {
                        c.append('<div class="GreenFinder-contextmenu-separator"/>'), h = !1;
                        return
                    }
                    j = b.command(e);
                    if (j && j.getstate(f) != -1) {
                        if (j.variants) {
                            ...
                            }), l = a('<div class="ui-corner-all GreenFinder-contextmenu-sub"/>').appendTo(k.append('<span class="GreenFinder-contextmenu-arrow"/>')), k.addClass("GreenFinder-contextmenu-group").hover(function () {
                                l.toggle()
                            }), a.each(j.variants, function (b, c) {
                                l.append(a('<div class="GreenFinder-contextmenu-item"><span>' + c[1] + "</span></div>").click(function (a) {
        ...
        return this.not(".GreenFinder-cwd").each(function () {
            var c = b.storage("view") == "list", d = "undefined", e = "select." + b.namespace, f = "unselect." + b.namespace, g = "disable." + b.namespace, h = "enable." + b.namespace, i = "class", j = b.res(i, "cwdfile"), k = "." + j, l = "ui-selected", m = b.res(i, "disabled"), n = b.res(i, "draggable"), o = b.res(i, "droppable"), p = b.res(i, "hover"), q = b.res(i, "adroppable"), r = j + "-tmp", s = b.options.loadTmbs > 0 ? b.options.loadTmbs : 5, t = "", u = {icon: '<div id="{hash}" class="' + j + ' {permsclass} {dirclass} ui-corner-all"><div class="GreenFinder-cwd-file-wrapper ui-corner-all"><div class="GreenFinder-cwd-icon {mime} ui-corner-all" unselectable="on" {style}/>{marker}</div><div class="GreenFinder-cwd-filename" title="{name}">{name}</div></div>', row: '<tr id="{hash}" class="' + j + ' {permsclass} {dirclass}"><td><div class="GreenFinder-cwd-file-wrapper"><span class="GreenFinder-cwd-icon {mime}"/>{marker}<span class="GreenFinder-cwd-filename">{name}</span></div></td><td>{perms}</td><td>{date}</td><td>{size}</td><td>{kind}</td></tr>'}, v = b.res("tpl", "perms"), w = b.res("tpl", "symlink"), x = {permsclass: function (a) {
                ...
                setTimeout(function () {
                    S.find(".directory:not(." + o + ",.GreenFinder-na,.GreenFinder-ro)").droppable(b.droppable)
                }, 20)
            }, M = function (c) {
                ...
                return a.each(c, function (b, c) {
                    ...
                    g.length ? function (b, c) {
                        a("<img/>").load(function () {
                            b.find(".GreenFinder-cwd-icon").css("background", "url('" + c + "') center center no-repeat")
                        }).attr("src", c)
            ...
            }), T = a('<div class="GreenFinder-cwd-wrapper"/>').bind("contextmenu", function (a) {
                a.preventDefault(), b.trigger("contextmenu", {type: "cwd", targets: [b.cwd().hash], x: a.clientX, y: a.clientY})
            }), U = function () {
                var b = 0;
                T.siblings(".GreenFinder-panel:visible").each(function () {
                    b += a(this).outerHeight(!0)
                }), T.height(W.height() - b)
            }, V = a(this).parent().resize(U), W = V.children(".GreenFinder-workzone").append(T.append(this));
        ...
        return typeof b == "string" && (c = this.closest(".ui-dialog")).length && (b == "open" && c.is(":hidden") ? c.fadeIn(120, function () {
            ...
            var c = a(this).addClass("ui-dialog-content ui-widget-content"), d = c.parent(), e = "GreenFinder-dialog-active", f = "GreenFinder-dialog", g = "GreenFinder-dialog-notify", h = "ui-state-hover", i = parseInt(Math.random() * 1e6), j = d.children(".GreenFinder-overlay"), k = a('<div class="ui-dialog-buttonset"/>'), l = a('<div class=" ui-helper-clearfix ui-dialog-buttonpane ui-widget-content"/>').append(k), m = a('<div class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-draggable std42-dialog  ' + f + " " + b.cssClass + '"/>').hide().append(c).appendTo(d).draggable({handle: ".ui-dialog-titlebar", containment: a("body")}).css({width: b.width, height: b.height}).mousedown(function (b) {
                ...
                var e = d.find(".GreenFinder-dialog:visible"), f = n();
        ...
        return this.not(".GreenFinder-navbar").each(function () {
            var d = a(this).addClass("ui-state-default GreenFinder-navbar"), e = d.parent().resize(function () {
                d.height(f.height() - g)
            }), f = e.children(".GreenFinder-workzone").append(d), g = d.outerHeight() - d.height(), h = b.direction == "ltr", i;
        ...
        this.filter(":not(.GreenFinder-overlay)").each(function () {
            b = a.extend({}, b), a(this).addClass("ui-widget-overlay GreenFinder-overlay").hide().mousedown(function (a) {
                a.preventDefault(), a.stopPropagation()
        ...
        return this.each(function () {
            var c = a(this).addClass("GreenFinder-panel ui-state-default ui-corner-all"), d = "margin-" + (b.direction == "ltr" ? "left" : "right");
        ...
        return this.each(function () {
            var c = a(this).addClass("GreenFinder-path").html("&nbsp;").delegate("a", "click",function (c) {
        ...
        return this.each(function () {
            var d = [], e = "class", f = b.res(e, "navdir"), g = b.res(e, "navcollapse"), h = b.res(e, "navexpand"), i = b.res(e, "hover"), j = b.res(e, "treeroot"), k = b.res("tpl", "navdir"), l = b.res("tpl", "perms"), m = a(b.res("tpl", "navspinner")), n = function (a) {
                ...
                w.children().length && a.each(w.children(), function () {
                    ...
                    var c = a(this);
                    return c.children().removeClass("ui-state-hover"), a('<div class="GreenFinder-place-drag GreenFinder-' + b.direction + '"/>').append(c.clone()).data("hash", n(c.children(":first").attr("id")))
                }, start: function () {
                    a(this).hide()
                }, stop: function (b, c) {
            ...
            }), w = u.children("." + b.res(e, "navsubtree")), x = a(this).addClass(b.res(e, "tree") + " GreenFinder-places ui-corner-all").hide().append(u).appendTo(b.getUI("navbar")).delegate("." + f, "hover",function () {
                a(this).toggleClass("ui-state-hover")
            ...
            }).droppable({tolerance: "pointer", accept: ".GreenFinder-cwd-file-wrapper,.GreenFinder-tree-dir,.GreenFinder-cwd-file", hoverClass: b.res("class", "adroppable"), drop: function (c, e) {
                var f = !0;
        ...
        return this.each(function () {
            var c = !1, d = a(this).hide().addClass("ui-widget-content GreenFinder-button " + b.fm.res("class", "searchbtn") + ""), e = function () {
        ...
        return this.each(function () {
            var c = "class", d = b.fm, e = d.res(c, "disabled"), f = d.res(c, "active"), g = d.res(c, "hover"), h = "GreenFinder-button-menu-item", i = "GreenFinder-button-menu-item-selected", j, k = a(this).addClass("ui-state-default GreenFinder-button elfiner-button-" + b.name).attr("title", b.title).append('<span class="GreenFinder-button-icon GreenFinder-button-icon-' + b.name + '"/>').hover(function (a) {
            ...
            a.isArray(b.variants) && (k.addClass("GreenFinder-menubutton"), j = a('<div class="ui-widget ui-widget-content GreenFinder-button-menu ui-corner-all"/>').hide().appendTo(k).zIndex(10 + k.zIndex()).delegate("." + h, "hover",function () {
                ...
                j.html(""), a.each(b.variants, function (c, d) {
                    j.append(a('<div class="' + h + " " + (d[0] == b.value ? i : "") + " GreenFinder-menu-item-sort-" + b.fm.sortDirect + '"><span class="GreenFinder-menu-item-sort-dir"/>' + d[1] + "</div>").data("value", d[0]))
                })
            })), b.change(function () {
                b.disabled() ? k.removeClass(f + " " + g).addClass(e) : (k.removeClass(e), k[b.active() ? "addClass" : "removeClass"](f))
            }).change()
        ...
        return this.each(function () {
            var c = a(this).addClass("GreenFinder-stat-size"), d = a('<div class="GreenFinder-stat-selected"/>'), e = b.i18n("size").toLowerCase(), f = b.i18n("items").toLowerCase(), g = b.i18n("selected"), h = function (d, g) {
                var h = 0, i = 0;
        ...
        return this.not(".GreenFinder-toolbar").each(function () {
            var d = b._commands, e = a(this).addClass("ui-helper-clearfix ui-widget-header ui-corner-top GreenFinder-toolbar"), f = c || [], g = f.length, h, i, j, k;
            e.prev().length && e.parent().prepend(this);
            while (g--)if (f[g]) {
                j = a('<div class="ui-widget-content ui-corner-all GreenFinder-buttonset"/>'), h = f[g].length;
                while (h--)if (i = d[f[g][h]])k = "GreenFinder" + i.options.ui, a.fn[k] && j.prepend(a("<div/>")[k](i));
                j.children().length && e.prepend(j), j.children(":not(:last),:not(:first):not(:last)").after('<span class="ui-widget-content GreenFinder-toolbar-button-separator"/>')
            }
        ...
        return this.not("." + d).each(function () {
            var e = "class", f = b.res(e, "treeroot"), g = c.openRootOnLoad, h = b.res(e, "navsubtree"), i = b.res(e, "treedir"), j = b.res(e, "navcollapse"), k = b.res(e, "navexpand"), l = "GreenFinder-subtree-loaded", m = b.res(e, "navarrow"), n = b.res(e, "active"), o = b.res(e, "adroppable"), p = b.res(e, "hover"), q = b.res(e, "disabled"), r = b.res(e, "draggable"), s = b.res(e, "droppable"), t = a.extend({}, b.droppable, {hoverClass: p + " " + o, over: function () {
                ...
                H.find("." + i + ":not(." + s + ",.GreenFinder-ro,.GreenFinder-na)").droppable(t)
            }, G = function (c, d) {
                ...
                d.is("." + o + " ,." + q) || (e && !d.is("." + f + ",." + r + ",.GreenFinder-na,.GreenFinder-wo") && d.draggable(b.draggable), d.toggleClass(p, e))
            ...
            H.parent().find(".GreenFinder-navbar").append(H).show(), b.open(function (a) {
        ...
        return this.each(function () {
            var c = a(this).elfinderbutton(b), d = c.children(".GreenFinder-button-icon");
            b.change(function () {
                var a = b.value == "icons";
                d.toggleClass("GreenFinder-button-icon-view-list", a), c.attr("title", b.fm.i18n(a ? "viewlist" : "viewicons"))
            })
        })
    }, a.fn.elfinderworkzone = function (b) {
        var c = "GreenFinder-workzone";
        ...
        var b = this, c = this.fm, d = c.res("mimes", "text") || [], e = function (c) {
            ...
            var g = a.Deferred(), h = a('<textarea class="GreenFinder-file-edit" rows="20" id="' + d + '-ta">' + c.escape(f) + "</textarea>"), i = function () {
        ...
        var b = this.fm, c = this, d = '<div class="GreenFinder-help-link"> <a href="{url}">{link}</a></div>', e = '<div class="GreenFinder-help-team"><div>{author}</div>{work}</div>', f = /\{url\}/, g = /\{link\}/, h = /\{author\}/, i = /\{work\}/, j = "replace", k = "ui-priority-primary", l = "ui-priority-secondary", m = "GreenFinder-help-license", n = '<li class="ui-state-default ui-corner-top"><a href="#{id}">{title}</a></li>', o = ['<div class="ui-tabs ui-widget ui-widget-content ui-corner-all GreenFinder-help">', '<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">'], p = '<div class="GreenFinder-help-shortcut"><div class="GreenFinder-help-shortcut-pattern">{pattern}</div> {descrip}</div>', q = '<div class="GreenFinder-help-separator"/>', r = function () {
            ...
            var c = b.shortcuts();
            o.push('<div id="shortcuts" class="ui-tabs-panel ui-widget-content ui-corner-bottom">'), c.length ? (o.push('<div class="ui-widget-content GreenFinder-help-shortcuts">'), a.each(c, function (a, b) {
                o.push(p.replace(/\{pattern\}/, b[0]).replace(/\{descrip\}/, b[1]))
            }), o.push("</div>")) : o.push('<div class="GreenFinder-help-disabled">' + b.i18n("shortcutsof") + "</div>"), o.push("</div>")
        }, t = function () {
            o.push('<div id="help" class="ui-tabs-panel ui-widget-content ui-corner-bottom">'), o.push('<a href="http://GreenFinder.org/forum/" target="_blank" class="GreenFinder-dont-panic"><span>DON\'T PANIC</span></a>'), o.push("</div>")
        }, u;
        ...
        this.tpl = {main: '<div class="ui-helper-clearfix GreenFinder-info-title"><span class="GreenFinder-cwd-icon {class} ui-corner-all"/>{title}</div><table class="GreenFinder-info-tb">{content}</table>', itemTitle: '<strong>{name}</strong><span class="GreenFinder-info-kind">{kind}</span>', groupTitle: "<strong>{items}: {num}</strong>", row: "<tr><td>{label} : </td><td>{value}</td></tr>", spinner: '<span>{text}</span> <span class="' + d + '"/>'}, this.alwaysEnabled = !0, this.updateOnSelect = !1, this.shortcuts = [
            ...
            j == 1 ? (v = i[0], l = l.replace("{class}", f.mime2class(v.mime)), w = g.itemTitle.replace("{name}", v.name).replace("{kind}", f.mime2kind(v)), v.tmb && (u = f.option("tmbUrl") + v.tmb), v.read ? v.mime != "directory" || v.alias ? t = f.formatSize(v.size) : (t = g.spinner.replace("{text}", e.calc), p.push(v.hash)) : t = e.unknown, k.push(h.replace(m, e.size).replace(n, t)), v.alias && k.push(h.replace(m, e.aliasfor).replace(n, v.alias)), k.push(h.replace(m, e.path).replace(n, f.escape(f.path
                ...
                q(a.dim || e.unknown)
            }))), k.push(h.replace(m, e.modify).replace(n, f.formatDate(v))), k.push(h.replace(m, e.perms).replace(n, f.formatPermissions(v))), k.push(h.replace(m, e.locked).replace(n, v.locked ? e.yes : e.no))) : (l = l.replace("{class}", "GreenFinder-cwd-icon-group"), w = g.groupTitle.replace("{items}", e.items).replace("{num}", j), x = a.map(i,function (a) {
                ...
                s.find(".GreenFinder-cwd-icon").css("background", 'url("' + u + '") center center no-repeat')
        ...
        var b = this, c = b.fm, d = 0, e = 1, f = 2, g = d, h = "GreenFinder-quicklook-navbar-icon", i = "GreenFinder-quicklook-fullscreen", j = function (b) {
            ...
            return c && c !== "" && c != "no"
        }, n, o, p, q, r = a('<div class="GreenFinder-quicklook-title"/>'), s = a("<div/>"), t = a('<div class="GreenFinder-quicklook-info"/>'), u = a('<div class="' + h + " " + h + '-fullscreen"/>').mousedown(function (d) {
        ...
        }), v = a('<div class="GreenFinder-quicklook-navbar"/>').append(a('<div class="' + h + " " + h + '-prev"/>').mousedown(function () {
                j(37)
            })).append(u).append(a('<div class="' + h + " " + h + '-next"/>').mousedown(function () {
                j(39)
            })).append('<div class="GreenFinder-quicklook-navbar-separator"/>'
        ).append(a('<div class="' + h + " " + h + '-close"/>').mousedown(function () {
                b.window.trigger("close")
            }));
        this.resize = "resize." + c.namespace, this.info = a('<div class="GreenFinder-quicklook-info-wrapper"/>').append(s).append(t), this.preview = a('<div class="GreenFinder-quicklook-preview ui-helper-clearfix"/>').bind("change",function (a) {
            b.info.attr("style", "").hide(), s.removeAttr("class").attr("style", ""), t.html("")
        }).bind("update", function (c) {
            var d = b.fm, e = b.preview, f = c.file, g = '<div class="GreenFinder-quicklook-info-data">{value}</div>', h;
        ...
        }), this.window = a('<div class="ui-helper-reset ui-widget GreenFinder-quicklook" style="position:absolute"/>').click(function (a) {
            a.stopPropagation()
        }).append(a('<div class="GreenFinder-quicklook-titlebar"/>').append(r).append(a('<span class="ui-icon ui-icon-circle-close"/>').mousedown(function (a) {
            a.stopPropagation(), b.window.trigger("close")
        }))).append(this.preview.add(v)).append(b.info.hide()).draggable({handle: "div.GreenFinder-quicklook-titlebar"}).bind("open",function (a) {
        ...
        d.bind("update", function (f) {
            ...
            a.inArray(g.mime, c) !== -1 && (f.stopImmediatePropagation(), d.one("change", function () {
                ...
                b.hideinfo(), doc = a('<iframe class="GreenFinder-quicklook-preview-html"/>').appendTo(d)[0].contentWindow.document, doc.open(), doc.write(c.content), doc.close()
            }))
        })
    }, function (b) {
        ...
        e.bind("update", function (f) {
            ...
            if (h.indexOf("text/") === 0 || a.inArray(h, d) !== -1)f.stopImmediatePropagation(), e.one("change", function () {
                ...
                b.hideinfo(), a('<div class="GreenFinder-quicklook-preview-text-wrapper"><pre class="GreenFinder-quicklook-preview-text">' + c.escape(d.content) + "</pre></div>").appendTo(e)
            })
        })
    }, function (b) {
        ...
        a.browser.safari && navigator.platform.indexOf("Mac") != -1 || a.browser.msie ? f = !0 : a.each(navigator.plugins, function (b, c) {
            ...
            }), h = a('<iframe class="GreenFinder-quicklook-preview-pdf"/>').hide().appendTo(e).load(function () {
                b.hideinfo(), h.show()
        ...
        a.each(navigator.plugins, function (b, c) {
            ...
            var g = f.file, h;
            g.mime == d && (f.stopImmediatePropagation(), b.hideinfo(), e.append(h = a('<embed class="GreenFinder-quicklook-preview-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" src="' + c.url(g.hash) + '" quality="high" type="application/x-shockwave-flash" />')))
        })
    }, function (b) {
        ...
        c.bind("update",function (g) {
            ...
            b.support.audio[i] && (g.stopImmediatePropagation(), f = a('<audio class="GreenFinder-quicklook-preview-audio" controls preload="auto" autobuffer><source src="' + b.fm.url(h.hash) + '" /></audio>').appendTo(c), d && f[0].play())
        ...
        c.bind("update",function (g) {
            var h = g.file, i = e[h.mime];
            b.support.video[i] && (g.stopImmediatePropagation(), b.hideinfo(), f = a('<video class="GreenFinder-quicklook-preview-video" controls preload="auto" autobuffer><source src="' + b.fm.url(h.hash) + '" /></video>').appendTo(c), d && f[0].play())
        }).bind("change", function () {
            f && f.parent().length && (f[0].pause(), f.remove(), f = null)
        })
    }, function (b) {
        ...
        a.each(navigator.plugins, function (b, c) {
            ...
            var g = f.file, h = g.mime, i;
            a.inArray(g.mime, d) !== -1 && (f.stopImmediatePropagation(), (i = h.indexOf("video/") === 0) && b.hideinfo(), e = a('<embed src="' + b.fm.url(g.hash) + '" type="' + h + '" class="GreenFinder-quicklook-preview-' + (i ? "video" : "audio") + '"/>').appendTo(c))
        }).bind("change", function () {
        ...
        this.shortcuts = [
            ...
            var b = this.fm, c = b.getUI("cwd"), d = b.selected(), e = d.length, f = b.file(d.shift()), g = ".GreenFinder-cwd-filename", h = a.Deferred().fail(function (a) {
        ...
        this.updateOnSelect = !1, this.getstate = function () {
            ...
            var c = this.fm, d = this.files(b), e = a.Deferred(), f = function (b, d) {
                var f = a('<div class="GreenFinder-dialog-resize"/>'), g = '<input type="text" size="5"/>', h = '<div class="GreenFinder-resize-row"/>', i = '<div class="GreenFinder-resize-label"/>', j = a('<div class="GreenFinder-resize-control"/>'), k = a('<div class="GreenFinder-resize-preview"/>'), l = a('<div class="GreenFinder-resize-spinner">' + c.i18n("ntfloadimg") + "</div>"), m = a('<div class="GreenFinder-resize-handle"/>'), n = a('<div class="GreenFinder-resize-handle"/>'), o = a('<div class="GreenFinder-resize-uiresize"/>'), p = a('<div class="GreenFinder-resize-uicrop"/>'), q = '<div class="ui-widget-content ui-corner-all GreenFinder-buttonset"/>', r = '<div class="ui-state-default GreenFinder-button"/>', s = '<span class="ui-widget-content GreenFinder-toolbar-button-separator"/>', t = a('<div class="GreenFinder-resize-rotate"/>'), u = a(r).attr("title", c.i18n("rotate-cw")).append(a('<span class="GreenFinder-button-icon GreenFinder-button-icon-rotate-l"/>').click(function () {
                    S -= 90, ab.update(S)
                })), v = a(r).attr("title", c.i18n("rotate-ccw")).append(a('<span class="GreenFinder-button-icon GreenFinder-button-icon-rotate-r"/>').click(function () {
                    S += 90, ab.update(S)
                })), w = a("<span />"), x = a('<div class="ui-state-default ui-corner-all GreenFinder-resize-reset"><span class="ui-icon ui-icon-arrowreturnthick-1-w"/></div>'), y = a('<div class="GreenFinder-resize-type"/>').append('<input type="radio" name="type" id="type-resize" value="resize" checked="checked" /><label for="type-resize">' + c.i18n("resize") + "</label>").append('<input type="radio" name="type" id="type-crop"   value="crop"/><label for="type-crop">' + c.i18n("crop") + "</label>").append('<input type="radio" name="type" id="type-rotate" value="rotate"/><label for="type-rotate">' + c.i18n("rotate") + "</label>"), z = a("input", y).change(function () {
                    ...
                    ab.update()
                }), I = a('<div class="GreenFinder-resize-rotate-slider"/>').slider({min: 0, max: 359, value: H.val(), animate: !0, change: function (a, b) {
                    ...
                    Q = L * b, R = M * b, j.find("input,select").removeAttr("disabled").filter(":text").keydown(function (b) {
                        ...
                        c == 9 && (d = a(this).parent()[b.shiftKey ? "prev" : "next"](".GreenFinder-resize-row").children(":text"), d.length && d.focus());
                        if (c == 13) {
                            eb();
                            return
                        }
                ...
                }, fb = {}, gb = "GreenFinder-resize-handle-hline", hb = "GreenFinder-resize-handle-vline", ib = "GreenFinder-resize-handle-point", jb = c.url(b.hash);
                ...
                }}).attr("id", d), a.browser.msie && parseInt(a.browser.version) < 9 && a(".GreenFinder-dialog").css("filter", ""), x.css("left", B.position().left + B.width() + 12), W.css({opacity: .2, "background-color": "#fff", position: "absolute"}), n.css("cursor", "move"), n.find(".GreenFinder-resize-handle-point").css({"background-color": "#fff", opacity: .5, "border-color": "#000"}), X.css("cursor", "pointer"), y.buttonset(), O = k.width() - (m.outerWidth() - m.width()), P = k.height() - (m.outerHeight() - m.height()), T.attr("src", jb + (jb.indexOf("?") === -1 ? "?" : "&") + "_=" + Math.random()), V.attr("src", T.attr("src")), X.attr("src", T.attr("src"))
            }, g, h;
        ...
        this.disableOnSearch = !0, this.updateOnSelect = !1, this.shortcuts = [
            ...
            return this.disabled() ? a.Deferred().reject() : c && (c.input || c.files) ? d.upload(c) : (f = a.Deferred(), h = a('<input type="file" multiple="true"/>').change(function () {
                ...
                i.toggleClass(b)
            }), g = a('<div class="GreenFinder-upload-dialog-wrapper"/>').append(i), d.dragUpload && (j = a('<div class="ui-corner-all GreenFinder-upload-dropbox">' + d.i18n("dropFiles") + "</div>").prependTo(g).after('<div class="GreenFinder-upload-dialog-or">' + d.i18n("or") + "</div>")[0], j.addEventListener("dragenter", function (c) {
