    ...
    <div id="tabBodys" class="tabbody">
        <div id="normal" class="panel">
            <fieldset class="bgarea">
                ...
                <div class="content">
                    <div>
                        <input class="iptradio" type="radio" name="t" value="none" checked="checked"
                               onclick="net(this)"><label><var id="lang_background_none"></var></label>
                    </div>
                    <div class="wrapcolor">
                        <div class="color">
                            <input class="iptradio" type="radio" name="t" value="color" onclick="net(this)"><label><var
                                id="lang_background_color"></var>:</label>
                        </div>
