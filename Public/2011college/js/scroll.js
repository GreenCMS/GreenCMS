...
function resize() {
	...
	var playList={
		...
		//--图片数组
		imgArray:[PUBLIC+"/images/slide.jpg",PUBLIC+"/images/slide2.jpg",PUBLIC+"/images/slide.jpg",PUBLIC+"/images/slide2.jpg"],
		//imgArray:sImgArray,
		//--链接数组
		linkArray:[PUBLIC+"/images/slide.jpg",PUBLIC+"/images/slide2.jpg",PUBLIC+"/images/slide.jpg",PUBLIC+"/images/slide.jpg"],
        //--商城链接数组
		...
		play:function(){
			$(document).ready(function(){
				...
				{
					$('#'+playList.displayDiv+' img').css({"position":"absolute","top":"0","left":"0","border":"none","opacity":"1","width":"1440px","height":"auto"});
					if(document.documentElement.clientWidth>=1200&&document.documentElement.clientWidth<=1440)
	{
	...
	else if(document.documentElement.clientWidth<=900)
	{
		...
		$("#globalproductList h1").css("left","265px");
				...
				$('#'+playList.displayDiv+' img').css({"position":"absolute","top":"0","left":"0%","border":"none","opacity":"0","width":"1440px","height":"auto"});
				if(document.documentElement.clientWidth>=1200&&document.documentElement.clientWidth<=1440)
	{
		$("#mainWindow img").css("margin-left",moreWidth);
		$(".containerIndex").css("width","90%");
